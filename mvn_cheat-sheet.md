...
| mvn org.codehaus.cargo:cargo-maven3-plugin:run                  | (from main war module) starts JSPWiki on a Tomcat 10 instance at http://localhost:8080/JSPWiki with an attached debugger on port 5005 |
