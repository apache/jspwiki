...
/**
 * Translates to wiki syntax from a {@code DD} element.
 */
public abstract class DdDecorator {
    ...
    protected DdDecorator( final PrintWriter out, final XHtmlElementToWikiTranslator chain ) {
        this.out = out;
        this.chain = chain;
    }
    ...
    /**
     * Wiki markup for a {@code dd} element.
     *
     * @return Wiki markup for a {@code dd} element.
     */
    protected abstract String markupDd();
