...
/**
 * Translates to wiki syntax from a {@code SUB} element.
 */
public abstract class SubDecorator {
    ...
    protected SubDecorator( final PrintWriter out, final XHtmlElementToWikiTranslator chain ) {
        this.out = out;
        this.chain = chain;
    }
    ...
    public void decorate( final Element e ) throws JDOMException {
        out.print( markupSubOpen() );
        chain.translate( e );
        out.print( markupSubClose() );
    }

    /**
     * Opening wiki markup for a {@code SUB} element.
     *
     * @return Opening wiki markup for a {@code SUB} element.
     */
    protected abstract String markupSubOpen();

    /**
     * Closing wiki markup for a {@code SUB} element.
     *
     * @return Closing wiki markup for a {@code SUB} element.
     */
