...
/**
 * Translates to wiki syntax from a {@code TABLE} element.
 */
public class TableDecorator {

    final protected PrintWriter out;
    final protected XHtmlElementToWikiTranslator chain;
    final protected WhitespaceTrimWriter outTrimmer;

    public TableDecorator( final PrintWriter out, final WhitespaceTrimWriter outTrimmer, final XHtmlElementToWikiTranslator chain ) {
        this.out = out;
        this.chain = chain;
