...
/**
 * JSPWiki syntax implementation of {@link ADecorator}.
 */
class JSPWikiADecorator extends ADecorator {

    JSPWikiADecorator( final PrintWriter out, final XHtmlToWikiConfig config, final XHtmlElementToWikiTranslator chain ) {
