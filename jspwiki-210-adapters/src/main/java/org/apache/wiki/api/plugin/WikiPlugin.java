...
public interface WikiPlugin extends Plugin {
    ...
    default String execute( final Context context, final Map< String, String > params ) throws PluginException {
        LoggerFactory.getLogger( WikiPlugin.class ).warn( this.getClass().getName() + " implements deprecated org.apache.wiki.api.plugin.WikiPlugin" );
        LoggerFactory.getLogger( WikiPlugin.class ).warn( "Please contact the plugin's author so there can be a new release of the plugin " +
