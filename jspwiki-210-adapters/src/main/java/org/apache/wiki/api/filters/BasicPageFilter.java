...
public class BasicPageFilter extends BasePageFilter {
    ...
    public void initialize( final WikiEngine engine, final Properties properties ) throws FilterException {
        ...
        LoggerFactory.getLogger( BasicPageFilter.class ).warn( this.getClass().getName() + " implements deprecated org.apache.wiki.api.filters.BasicPageFilter" );
        LoggerFactory.getLogger( BasicPageFilter.class ).warn( "Please contact the filter's author so there can be a new release of the filter " +
