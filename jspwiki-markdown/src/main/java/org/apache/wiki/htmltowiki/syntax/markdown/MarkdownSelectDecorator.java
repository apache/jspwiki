...
/**
 * Markdown syntax implementation of {@link SelectDecorator}.
 */
class MarkdownSelectDecorator extends SelectDecorator {

    MarkdownSelectDecorator( final PrintWriter out, final XHtmlElementToWikiTranslator chain ) {
        super( out, chain );
    }
