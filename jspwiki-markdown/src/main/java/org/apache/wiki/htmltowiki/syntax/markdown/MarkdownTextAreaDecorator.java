...
/**
 * Markdown syntax implementation of {@link TextAreaDecorator}.
 */
class MarkdownTextAreaDecorator extends TextAreaDecorator {

    MarkdownTextAreaDecorator( final PrintWriter out, final XHtmlElementToWikiTranslator chain ) {
        super( out, chain );
    }
