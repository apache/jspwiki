...
/**
 * Markdown syntax implementation of {@link PlainTextCssSpecialDecorator}.
 */
class MarkdownPlainTextCssSpecialDecorator extends PlainTextCssSpecialDecorator {
    ...
    /** {@inheritDoc} */
    @Override
    protected String markupCssSpecialDivClose( final String cssStyle ) {
    ...
    /** {@inheritDoc} */
    @Override
    protected String markupCssSpecialClose( final String cssStyle ) {
        return " { style='" + cssStyle + "' }";
    }
