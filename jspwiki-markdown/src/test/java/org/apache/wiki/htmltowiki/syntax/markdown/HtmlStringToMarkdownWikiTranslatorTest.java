...
/**
 * JUnit test cases for Converting Html to Markdown Wiki Markup.
 */
public class HtmlStringToMarkdownWikiTranslatorTest {
    ...
    public void testWhitespace() throws Exception {
        Assertions.assertEquals( StringUtils.EMPTY, html2wiki.translate( StringUtils.EMPTY ) );
        Assertions.assertEquals( StringUtils.EMPTY, html2wiki.translate( "   " ) );
        Assertions.assertEquals( StringUtils.EMPTY, html2wiki.translate( "<div>\n\n\n</div>" ) );
    ...
    public void testCenter() throws Exception {
        ...
        Assertions.assertEquals( "**Hello   \nWorld! { style=' text-align: center; display: block;' }**",
    ...
    public void testCSS() throws Exception {
        Assertions.assertEquals( "Und niemand wird sie sehen { style=' color: rgb(255, 0, 0);' }, die",
    ...
    public void testParsing() throws Exception {
        ...
        Assertions.assertEquals( "a", html2wiki.translate( "a" ) );
        Assertions.assertEquals( "a   \nb", html2wiki.translate( "a<br/>b" ) );
        Assertions.assertEquals( " \\", html2wiki.translate( "   \n\\" ) );
        Assertions.assertEquals( "[{Test Hello World!}]()", html2wiki.translate( "[{Test   \n   \nHello World!}]()" ) );
        Assertions.assertEquals( "``[{Test Hello World!}]()``", html2wiki.translate( "``[{Test   \n   \nHello World!}]()``" ) );
        Assertions.assertEquals( "``[{Test Hello World!}]()````[{Test   \nHello World!}]()``[{Test Hello World!}]()[{Test Hello World!}]()", html2wiki
                  .translate( "``[{Test   \nHello World!}]()````[{Test<br>Hello World!}]()``[{Test   \n   \nHello World!}]()[{Test   \n   \nHello World!}]()" ) );
    }

    @Test
    public void testBoldAndItalic() throws Exception {
        Assertions.assertEquals( "Dies ist **bold**, _italic_ und **_both_**.", html2wiki.translate(
        ...
        Assertions.assertEquals( "Dies ist **bold**, _italic_ und **_both_** 2.",
                html2wiki.translate( "Dies ist <b>bold</b>, <i>italic</i> und <b><i>both</i></b> 2." ) );

        Assertions.assertEquals( "Dies ist **bold**, _italic_ und **_both_** 3.",
                html2wiki.translate( "Dies ist <strong>bold</strong>, <em>italic</em> und <strong><em>both</em></strong> 3." ) );

        Assertions.assertEquals( "Wilma: _Ich m\u00f6chte hiermal in allerDeutlichkeit sagen! _",
