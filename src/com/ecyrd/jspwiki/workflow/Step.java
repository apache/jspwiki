 ...
 * <li><strong>availableOutcomes</strong>: an array of possible "outcomes,"
 * such as "approve decision" ({@link Outcome#DECISION_APPROVE}), "reassign
 * decision" ({@link Outcome#DECISION_REASSIGN}), "abort step" ({@link Outcome#STEP_ABORT})
 * and others. The range of possible Outcomes for the Step is returned by
 * {@link Step#availableOutcomes()}; see the Outcome class for more details.</li>
 * <li><strong>errors</strong>: an array of Strings indicating errors returned
 * by the Step. These values are returned by {@link Step#errors()}.</li>
 ...
 * <li><strong>startTime</strong> and <strong>endTime</strong>: the time, in
 * milliseconds, when the Step started and finished. These values are returned
 * by {@link Step#getStartTime()} and {@link Step#getEndTime()}, respectively.</li>
 ...
 * See also {@link Workflow#getMessageArguments()}, which is a convenience method that
...
public interface Step
{
    ...
    /**
     * Returns an array of available outcomes, such as "approve", "deny" or
     * "reassign". Concrete implementations should always return a defensive
     * copy of the outcomes, not the original backing array.
     * 
     * @return the set of outcomes
     */
    public Outcome[] availableOutcomes();

    /**
     * Returns an array of error strings generated by this Step. If this Step
    ...
    /**
     * The end time, in milliseconds, for this Step. This value should be set
     * when the step completes. Returns {@link Workflow#TIME_NOT_SET} if not
     * completed yet.
     * 
     * @return the end time
     */
    ...
    /**
     * The start time, in milliseconds, for this Step. Returns
     * {@link Workflow#TIME_NOT_SET} if not started yet.
     * 
     ...
     *             returned by {@link #availableOutcomes()}
     */
     ...
     */
    public Step successor(Outcome outcome);
