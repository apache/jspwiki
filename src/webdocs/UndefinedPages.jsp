...
<HEAD>
  <TITLE><%=wiki.getApplicationName()%>: Undefined WikiPages</TITLE>
...
<P>
The following non-existant pages have been referred to in other WikiPages. 
Why don't you go create a few?
<P>
<jspwiki:linklist action="getmissing" linesep="true" />
<P>
