   ...
   <wiki:CheckRequestContext context="comment">
        <table border="0" class="small">
          <tr>
            ...
            <td><input type="text" name="author" id="authorname" value="<%=TextUtil.replaceEntities((String)session.getAttribute("author"))%>" /></td>
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="link" id="link" size="40" value="<%=TextUtil.replaceEntities((String)session.getAttribute("link"))%>" /></td>
          </tr>
        </table>
    </wiki:CheckRequestContext>
