...
/**
 * Translates to wiki syntax from a {@code OL} element.
 */
public abstract class OlDecorator {
    ...
    /**
     * Wiki markup for a {@code OL} element.
     *
     * @return Wiki markup for a {@code OL} element.
     */
    protected abstract String markupOl();
