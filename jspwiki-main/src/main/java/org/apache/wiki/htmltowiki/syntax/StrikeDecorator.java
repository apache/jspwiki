...
/**
 * Translates to wiki syntax from a {@code STRIKE} element.
 */
public abstract class StrikeDecorator {
    ...
    protected StrikeDecorator( final PrintWriter out, final XHtmlElementToWikiTranslator chain ) {
        this.out = out;
        this.chain = chain;
    }
    ...
    public void decorate( final Element e ) throws JDOMException {
        out.print( markupStrikeOpen() );
        chain.translate( e );
        out.print( markupStrikeClose() );
    }

    /**
     * Opening wiki markup for a {@code STRIKE} element.
     *
     * @return Opening wiki markup for a {@code STRIKE} element.
     */
    protected abstract String markupStrikeOpen();

    /**
     * Closing wiki markup for a {@code STRIKE} element.
     *
     * @return Closing wiki markup for a {@code STRIKE} element.
     */
