...
class PlainTextDecorator {
    ...
    final PlainTextCssDecorator ptcd;

    PlainTextDecorator( final PrintWriter out, final Stack< String > preStack, final XHtmlElementToWikiTranslator chain ) {
        this.out = out;
        this.preStack = preStack;
        this.chain = chain;
        this.ptcd = new PlainTextCssDecorator( out, preStack, chain );
    }
