...
/**
 * Translates to JSPWiki syntax from a {@link Text} element.
 */
class TextElementDecorator {
    ...
    TextElementDecorator( final PrintWriter out, final Stack< String > preStack ) {
        this.out = out;
     ...
     */
    void decorate( final Text element ) {
