...
/**
 * Translates to JSPWiki syntax from a table element.
 */
class TableDecorator {
    ...
    TableDecorator( final PrintWriter out, final WhitespaceTrimWriter outTrimmer, final XHtmlElementToWikiTranslator chain ) {
        this.out = out;
        this.chain = chain;
