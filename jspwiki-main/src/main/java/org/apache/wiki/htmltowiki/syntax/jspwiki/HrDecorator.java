...
/**
 * Translates to JSPWiki syntax from an HR element.
 */
class HrDecorator {
    ...
    HrDecorator( final PrintWriter out, final XHtmlElementToWikiTranslator chain ) {
        this.out = out;
        this.chain = chain;
    }
    ...
    void decorate( final Element e ) throws JDOMException {
        out.println();
        MarkupHelper.printUnescaped( out, "----" );
        chain.translate( e );
        out.println();
    }
